...
export const VIDEOS_BY_LANG: Record<Lang, VideoItem[]> = {
  ko: [
    ...
    },
    {
      ...
      kind: "youtube", slug: "readingclub", id: "EmL8_AFN7yU",
      title: "의지가 세진 게 아니에요", sub: "독서동호회 나가면 왜 갑자기 책이 읽힐까",
      transcript: "독서동호회 나가면 신기하게 책이 읽히죠. 의지가 세진 게 아니에요. 목요일 여덟 시에 나를 기다리는 자리가 있었던 겁니다. 혼자 읽기가 무너지는 건 하루 빼먹어서가 아니라, 돌아올 자리가 없어서예요. 모임을 찾기 전에 자리부터 만드세요. 캘린더에 매주 같은 요일, 같은 시각, 구십 분.",
    },
    {
      publishedAt: "2026-08-28T09:30:00+09:00",
      kind: "youtube", slug: "selfhelp-book", id: "aLCfjZinCqo",
      title: "책이 나빠서가 아닙니다. 순서가 틀린 거예요", sub: "자기계발서 스무 권 읽어도 그대로인 이유",
      transcript: "자기계발서 스무 권 읽어도 그대로인 건, 책이 나빠서가 아닙니다. 순서가 틀린 거예요. 불씨가 꺼졌으면 동기부여형, 할 마음은 있는데 방법이 없으면 시스템형, 방법은 아는데 나를 의심하면 사고전환형. 지금 내 상태에 맞는 한 권만 고르세요. 목록 스무 권보다, 이번 달에 끝낼 한 권이 낫습니다.",
    },
    {
      publishedAt: "2026-08-31T09:50:00+09:00",
      kind: "youtube", slug: "goal100", id: "YrCnQrzro4Q",
    ...
    {
      publishedAt: "2026-09-06T09:42:00+09:00",
      kind: "youtube", slug: "topperformer", id: "_SW2IeuAKVg",
      title: "야근은 제일 많이 하는데 평가는 중간이라면, 실력 문제가 아닙니다", sub: "일잘러는 빠른 사람이 아니었습니다",
      transcript: "야근은 제일 많이 하는데 평가는 늘 중간이라면, 실력 문제가 아닙니다. 일잘러는 빨리 하는 사람이 아니라, 남이 내 일의 끝을 예측할 수 있게 만드는 사람이에요. 그래서 마감 직전 완성본 대신, 절반 왔을 때 초안을 먼저 보냅니다. 오늘 할 일 목록에서 두 개만 지우고 내일로 옮겨보세요.",
    },
    {
      publishedAt: "2026-09-10T09:28:00+09:00",
      kind: "youtube", slug: "five-min-review", id: "p31keSGpBe0",
      title: "하루 빼먹으면 다 놓아버렸다면", sub: "회고했는데 왜 또 무너질까",
      transcript: "하루라도 빼먹으면 '난 역시 안 되나 봐' 하고 다 놓아버린 적 있죠. 회고가 '오늘 못 한 일'을 노려보는 시간이 되면 그렇게 돼요. 회고는 반성이 아니라 오늘을 닫는 거예요. 딱 세 줄이면 돼요. 잘한 것 하나, 아쉬운 것 하나, 내일 할 것 하나. 못 끝낸 일은 사라지지 않고 내일로 넘어갈 뿐이에요. 오늘 밤 딱 5분, 세 줄만 적어봐요.",
    },
    {
      publishedAt: "2026-09-15T09:59:00+09:00",
      kind: "youtube", slug: "growth-mindset", id: "iFuP86GwpZ8",
      title: "'나는 원래 이런 거 못해', 이번 주 몇 번 하셨나요?", sub: "실패했을 때 이 말버릇 하나가 갈라요",
      transcript: "'나는 원래 이런 거 못해', 이번 주 몇 번 하셨나요? 사실 그건 의지가 아니라 마인드셋 문제예요. 실패는 판결이 아니라 데이터일 뿐이에요. '못해' 뒤에 '아직' 한 글자만 붙여보세요. 비전드림에서 오늘부터 작은 증거를 쌓아가요.",
    },
    {
      publishedAt: "2026-09-19T09:02:00+09:00",
      kind: "youtube", slug: "selfcontrol", id: "gWoivmVWw7U",
      title: "작심삼일, 의지가 약해서라고 생각했나요?", sub: "작심삼일, 의지 문제가 아니었어요",
      transcript: "작심삼일, 의지가 약해서라고 생각했나요? 의지력이 근육처럼 고갈된다는 이론, 최근 연구에서 재현이 안 됐어요. 진짜 변수는 '이 계획이 지켜질 거란 신뢰'예요. 계획을 작게 세우고, 지켜지는 걸 먼저 확인하세요. 비전드림 스트릭 보호권이 그 신뢰를 지켜줄게요.",
    },
    {
      publishedAt: "2026-09-25T09:37:00+09:00",
      kind: "youtube", slug: "vipassana", id: "H66O4-KxNnQ",
      title: "위빠사나, 사흘 하고 멈추셨죠?", sub: "명상하다 딴생각? 그게 정답이에요",
      transcript: "위빠사나, 사흘 하고 멈추셨죠? 딴생각이 나서요. 그런데 위빠사나는 비우는 게 아니라 돌아오는 연습이에요. 딴생각이 들면 속으로 생각, 이름 한 번 붙이고 호흡으로 돌아오면 끝. 열 번 흩어지면 열 번 연습한 거예요. 오늘 딱 오 분, 몇 번 돌아왔는지만 적어 보세요.",
    },
  ],
  en: [
    {
